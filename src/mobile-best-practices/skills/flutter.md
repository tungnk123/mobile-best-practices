...
description: "Flutter development intelligence with Dart. 49 architecture patterns, 117 design patterns, 91 UI patterns, 113 anti-patterns, 103 libraries, 228 performance rules, 437 security practices, 73 testing patterns, 54 Flutter-specific guidelines. Default stack: BLoC/Riverpod + Dio + GoRouter + Drift + CachedNetworkImage. Actions: plan, build, create, design, implement, review, fix, improve, optimize, refactor, architect Flutter apps."
---
